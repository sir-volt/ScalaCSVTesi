...
class DoubleSpecificColumnPlot(override val data: MultipleSeries[Double, List[Double]], val column: Int,
override val resolution: (Int, Int)) extends PlotMultipleSeries[Double, Double, List[Double]] {
